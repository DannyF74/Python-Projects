...
def load_gui(self):
    ...
    self.lbl_user = tk.Label(self.master,text='Students: ')
    ...
    self.lstList1.bind('<<ListboxSelect>>',lambda event: tracker_func.onSelect(self,event))
    ...
    self.btn_update = tk.Button(self.master,width=12,height=2,text='Update',command=lambda: tracker_func.onUpdate(self))
    ...
    self.btn_close.grid(row=10,column=4,padx=(15,0),pady=(45,10),sticky=W)
